...
-- Module Name:           Xilinx Kintex 7 & Virtex 7 - RX_FRAMECLK phase aligner control      
--                                                                                                 
-- Language:              VHDL'93                                                              
--                                                                                                   
...
--=================================================================================================--
   ...
   main: process(RESET_I, RX_WORDCLK_I)   
      constant NUM_SHIFTS                       : integer := 280;
      ...
      ------------------------------------------
      variable counter                          : integer range 0 to 840;   -- Comment: (2e2 - 1) * 280 = 840
   ...
   pll: entity work.xlx_k7v7_gbt_rx_frameclk_phalgnr_mmcm          -- Comment: -- MMCM Configuration: -- 
      port map (                                                   --          -- M = 5               -- 
         -- Reset:                                                 --          -- D = 1               --
         RESET                                  => RESET_I,        --          -- OD = 15             -- 
