...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work alt_cv_gt_reset_txpll
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work alt_cv_gt_reset_txpll
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work alt_cv_gt_reset_txpll
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work alt_cv_gt_reset_txpll
  vhdlan -xlrm          "$QSYS_SIMDIR/alt_cv_gt_reset_txpll.vhd"                                                         
fi
