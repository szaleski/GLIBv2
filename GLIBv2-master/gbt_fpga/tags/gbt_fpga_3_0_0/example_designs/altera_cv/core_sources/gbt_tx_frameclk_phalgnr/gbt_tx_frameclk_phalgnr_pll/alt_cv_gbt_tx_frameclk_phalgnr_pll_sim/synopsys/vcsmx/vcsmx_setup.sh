...
# ACDS 13.1 162 win32 2014.04.10.04:24:26
...
TOP_LEVEL_NAME="alt_cv_gbt_tx_frameclk_phalgnr_pll"
QSYS_SIMDIR="./../../"
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm "$QSYS_SIMDIR/alt_cv_gbt_tx_frameclk_phalgnr_pll.vho"
fi
