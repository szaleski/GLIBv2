...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/altera_xcvr_functions.sv"      -work alt_sv_gt_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_h.sv"                  -work alt_sv_gt_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_plls.sv"               -work alt_sv_gt_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_reconfig_bundle_to_xcvr.sv" -work alt_sv_gt_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_avmm_csr.sv"           -work alt_sv_gt_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_pll_sv/alt_xcvr_resync.sv"            -work alt_sv_gt_txpll
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L alt_sv_gt_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixv -L stratixv_hssi -L stratixv_pcie_hip $TOP_LEVEL_NAME
}
