...
TOP_LEVEL_NAME="alt_sv_gt_txpll"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/alt_sv_gt_txpll/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/altera_xcvr_functions.sv"      -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_h.sv"                  -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_plls.sv"               -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_reconfig_bundle_to_xcvr.sv" -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/sv_xcvr_avmm_csr.sv"           -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_sv/alt_xcvr_resync.sv"            -work alt_sv_gt_txpll -cdslib ./cds_libs/alt_sv_gt_txpll.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/alt_sv_gt_txpll.vhd"                                                                                              
fi
