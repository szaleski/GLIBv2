...
# ACDS 13.1 162 win32 2014.04.02.17:54:27
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "alt_sv_gbt_tx_frameclk_stdpll"
}
...
alias dev_com {
  ...
  if ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] {
    ...
    vlog     "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/stratixv_atoms_ncrypt.v"          -work stratixv         
    ...
    vlog     "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/stratixv_hssi_atoms_ncrypt.v"     -work stratixv_hssi    
    ...
    vlog     "$QUARTUS_INSTALL_DIR/eda/sim_lib/mentor/stratixv_pcie_hip_atoms_ncrypt.v" -work stratixv_pcie_hip
...
alias com {
  echo "\[exec\] com"
  vcom "$QSYS_SIMDIR/alt_sv_gbt_tx_frameclk_stdpll.vho"
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixv -L stratixv_hssi -L stratixv_pcie_hip $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixv -L stratixv_hssi -L stratixv_pcie_hip $TOP_LEVEL_NAME
}
