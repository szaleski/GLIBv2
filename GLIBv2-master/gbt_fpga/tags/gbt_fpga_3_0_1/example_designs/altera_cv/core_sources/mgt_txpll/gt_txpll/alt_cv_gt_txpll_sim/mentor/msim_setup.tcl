...
# ACDS 13.1 162 win32 2014.04.07.22:32:03
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/altera_xcvr_functions.sv"             -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/altera_xcvr_functions.sv"      -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_h.sv"                         -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_plls.sv"                      -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_reconfig_bundle_to_xcvr.sv"        -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_avmm_csr.sv"                  -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/av_xcvr_h.sv"                  -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/av_xcvr_plls.sv"               -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/av_reconfig_bundle_to_xcvr.sv" -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/av_xcvr_avmm_csr.sv"           -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/alt_xcvr_resync.sv"                   -work alt_cv_gt_txpll
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_pll_cv/mentor/alt_xcvr_resync.sv"            -work alt_cv_gt_txpll
  vcom     "$QSYS_SIMDIR/alt_cv_gt_txpll.vhd"                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L alt_cv_gt_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L alt_cv_gt_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
