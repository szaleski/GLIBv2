...
TOP_LEVEL_NAME="alt_sv_gbt_tx_frameclk_stdpll"
QSYS_SIMDIR="./../"
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvlog      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/stratixv_atoms_ncrypt.v"          -work stratixv         
  ...
  ncvlog      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/stratixv_hssi_atoms_ncrypt.v"     -work stratixv_hssi    
  ...
  ncvlog      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/stratixv_pcie_hip_atoms_ncrypt.v" -work stratixv_pcie_hip
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 "$QSYS_SIMDIR/alt_sv_gbt_tx_frameclk_stdpll.vho"
fi
