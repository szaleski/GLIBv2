...
# ACDS 13.1 162 win32 2014.03.26.15:04:20
...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work alt_sv_gt_reset_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work alt_sv_gt_reset_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work alt_sv_gt_reset_txpll
  vlog  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work alt_sv_gt_reset_txpll
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L alt_sv_gt_reset_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L alt_sv_gt_reset_txpll -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim $TOP_LEVEL_NAME
}
