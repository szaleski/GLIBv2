...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/altera_xcvr_functions.sv"      -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_h.sv"                  -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_plls.sv"               -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_reconfig_bundle_to_xcvr.sv" -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/av_xcvr_avmm_csr.sv"           -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvlog -sv  "$QSYS_SIMDIR/altera_xcvr_pll_cv/alt_xcvr_resync.sv"            -work alt_cv_gt_txpll -cdslib ./cds_libs/alt_cv_gt_txpll.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/alt_cv_gt_txpll.vhd"                                                                                              
fi
