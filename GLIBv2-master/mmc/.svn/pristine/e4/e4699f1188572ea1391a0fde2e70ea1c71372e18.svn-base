...
//***************************/
{
    ...
    if (sensor == TEMPERATURE_SENSOR1)
        saddr = 0x54; // this sensor is supplied by the MP. //MJ: The real 7 bit address is 0x2A.
    if (sensor == TEMPERATURE_SENSOR2)
        saddr = 0x34; // this sensor is supplied via the PP (only accessible when in M4). //MJ: The real 7 bit address is 0x1A.
