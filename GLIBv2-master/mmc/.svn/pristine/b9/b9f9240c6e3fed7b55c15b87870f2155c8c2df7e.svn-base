   ...
   { 
     ...
     do{
       ...
       reclen = data[2] + 5;
	    ...
	    if( (data[0] == 0xc0) &&  (data[5] == 0x5A) && (data[6] == 0x31) && 
	             ( data[8] == 0x30) )
	    {
		  ...
		  if( (data[0] == 0x03) && (data[1] == 0x3F) && (data[2] == 0x05) && (data[3] == 0x00)
		            && ( data[4] == 0) && (data[5] == 0) && (data[6]== 0x02) && (data[7] == 0x08))
