...
#define MAX_IPMI_DATA_SIZE 0x20
...
{
   unsigned char ipmb_rqs:1;
   unsigned char event:1;
   unsigned char event_pending:1;
   unsigned char connected:1;
}ipmi_status;

typedef struct ipmi_event
{
...
//ipmb message receive 
void ipmb_get(u08 receiveDataLength, u08* receiveData);

//!send ipmi message
void ipmb_send_rsp( u08 error );

//send event message
void ipmb_send_event();


//obtain geographical address of ipmb
u08 get_address();
