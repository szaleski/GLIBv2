...
u08 ipmi_set_fru_led_state(u08 LedId, u08 LedFn, u08 LedOn);
u08 ipmi_get_fru_led_state(u08 LedId, u08 *buf);
u08 ipmi_get_fru_led_properties(u08 *buf);
u08 ipmi_get_led_color_capabilities(u08 LedId, u08 *buf);
