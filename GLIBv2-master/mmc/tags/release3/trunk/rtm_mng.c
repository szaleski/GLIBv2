...
//*******************/
{
    ...
    else       //RTM is present  Step MTCA.4, 3.5.1-1 OK
    {
        ...
        case M0:
            ...
            //MJ: MTCA.4, 3.5.1-4) says "enable the module hot swap sensor of the RTM". Does that mean that before this is is done the MMC does not
            //    add that sensor to the list of sensors sent in response to a "get SDR" command?
        ...
        case M2:
            ...
            //We have to mask the sensors in the SDR before we get to this point?
            rtm_sensor_enable = 1;
            //MTCA.4, 3.5.1-12 OK
